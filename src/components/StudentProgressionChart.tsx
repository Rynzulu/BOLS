...
export function StudentProgressionChart({
  ...
  const { progressionByTerm, subjectProgressionSummary, termAverages, overallImprovement } = useMemo(() => {
    ...
    TERMS.forEach((termName, idx) => {
      ...
      subjects.forEach(subj => {
        ...
        const point = assessment ? assessment.eczGrade : 9;
        ...
        if (assessment) {
          ...
          if (termName === "Term 3") {
            ...
            summaryMap[subj].latestRemark = assessment.remark;
          }
        }
      });
      ...
      termEntry.best5Points = pointsArr.slice(0, 5).reduce((a, b) => a + b, 0);
  ...
  }, [student.id, student.classId, gradebook, subjects, metricType]);
            ...
            >
              <div>
                ...
                <span className="text-[11px] text-slate-500 block">
                  Best 5 Aggregate: <strong className="text-emerald-700">{t.best5} pts</strong>
                </span>
              </div>
