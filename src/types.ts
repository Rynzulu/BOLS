...
export interface SecondaryPathwayInfo {
  ...
  accentColor: string;
  iconName: string;
  level: "Junior Secondary (Grades 8-9)" | "Senior Secondary (Grades 10-12)";
  coreSubjects: string[];
...
export interface SubjectAssessment {
  ...
  midTermScore: number; // Mid-Term test out of 20
  endTermScore: number; // End-of-Term exam out of 50
...
export interface TransportRoute {
  ...
  stops: (string | { name: string; time: string })[];
}
